...
//        if (host.substring(0, 5).equals("slave") & checkPort(host, 8080)) {
...
//        String slave = nodeDefiner.nodeDef(query, nodepath, log);
//
//        int ind = query.indexOf(" ");
//        String command = query.substring(0, ind);
//
//        String url_m = master_node;
...
//        List <String> nodes = log.readNode(nodepath);
//        return nodes;
//    }
//
//    @GetMapping("/validate")
